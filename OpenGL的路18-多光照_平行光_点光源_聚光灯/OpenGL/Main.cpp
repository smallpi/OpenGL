...
void onDraw(GLFWwindow* window){
    ...
    shader.setFloat("pointLight[0].kl",0.007f);
    shader.setFloat("pointLight[0].kq",0.0002f);
    ...
    shader.setFloat("pointLight[1].kl",0.007f);
    shader.setFloat("pointLight[1].kq",0.0002f);
    ...
    shader.setFloat("pointLight[2].kl",0.007f);
    shader.setFloat("pointLight[2].kq",0.0002f);
    ...
    for(int i=0; i<10; i++){
        mat4 transform(1.0f);
        float angle = 20.0f * i;
        mat::rotate(transform, TO_RADIAN(angle), 0.6f, 0.0f, 0.8f);

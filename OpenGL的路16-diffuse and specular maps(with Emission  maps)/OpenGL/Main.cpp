...
void onInit(void){
    ...
    textureEmission = Texture::loadTexture(GL_TEXTURE_2D,"./images/emission.jpg");
...
int main(int argc, char** argv){
    ...
    // 创建windows mode的窗口
    // 并创建OpenGL环境
    window = glfwCreateWindow(640, 480, "OpenGL's road - A wood box-diffuse and specular maps (with emission maps", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
        return -1;

...
void onInit(void){
	...
	/*skybox.push_back("./images/skybox_right.tga");
	skybox.push_back("./images/skybox_left.tga");
	skybox.push_back("./images/skybox_top.tga");
	skybox.push_back("./images/skybox_bottom.tga");
	skybox.push_back("./images/skybox_back.tga");
	skybox.push_back("./images/skybox_front.tga");*/
	/*skybox.push_back("./images/right.jpg");
	skybox.push_back("./images/left.jpg");
	skybox.push_back("./images/back.jpg");
	skybox.push_back("./images/front.jpg");
	skybox.push_back("./images/top.jpg");
	skybox.push_back("./images/bottom.jpg");*/
	//skybox.push_back("./images/right.jpg");
	//skybox.push_back("./images/left.jpg");
	//skybox.push_back("./images/top.jpg");
	//skybox.push_back("./images/bottom.jpg");
	...
	//skybox.push_back("./images/front.jpg");
	/**
	 * 前后左右的图片都要旋转180度，上下的图片不变
	 * （前提是加载图片需要上下翻转）
	 * （原因是OpenGL的纹理坐标和图片中像素坐标刚好是上下翻转的）
	 */
	skybox.push_back("./images/testright.jpg");
	skybox.push_back("./images/testleft.jpg");
	skybox.push_back("./images/testtop.jpg");
	skybox.push_back("./images/testbottom.jpg");
	skybox.push_back("./images/testback.jpg");
	skybox.push_back("./images/testfront.jpg");
	textureSkybox = Texture::loadCubemap(skybox);
	...
	skyboxShader.compile(GL_VERTEX_SHADER,"./skybox_vert.glsl",
...
void onDraw(GLFWwindow* window){
	...
	skyboxShader.use();
	mat::toSkyboxView(viewMat);
	skyboxShader.setMat4v("view",viewMat.data(),true);
	skyboxShader.setMat4v("project",projectMat.data(),true);
	glBindVertexArray(skyboxVAO);
...
int main(int argc, char** argv){
    ...
    // 创建windows mode的窗口
    // 并创建OpenGL环境
    window = glfwCreateWindow(640, 480, "OpenGL's road - Environment mapping", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
        return -1;

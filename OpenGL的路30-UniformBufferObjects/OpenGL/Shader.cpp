...
// 将uniform block绑定到binding point
void Shader::uniformBlockBinding(const char* name, unsigned int bindingPoint){
	glUniformBlockBinding(m_shaderId, glGetUniformBlockIndex(m_shaderId,name), bindingPoint);
}